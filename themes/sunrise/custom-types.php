...
function create_taxnews() {
    ...
    register_taxonomy( 'taxnews', array('hotnews'), $args );
}
...
function register_post_news() {
    $args = array(
        ...
        */
        ...
        'rewrite' => array(
            'slug' => 'hotnews', // Текст в ссылке. По умолчанию: значение $post_type.
        ...
        'show_in_rest' => false, // Представлять ли этот тип записи в REST API. По умолчанию: false.
         // Базовый ярлык данного типа записи когда доступно использование REST API. По умолчанию: значение $post_type.
